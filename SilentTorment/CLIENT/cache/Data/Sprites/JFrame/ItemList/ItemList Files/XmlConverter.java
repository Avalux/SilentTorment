...
/**
 *
 * Decompiled, wanted to change the theme/name.
 * 		- Didn't work, doesn't load the file.
 *
 */
...
public class XmlConverter implements ActionListener, KeyListener {
    ...
    private void readStream(DataInputStream datainputstream) throws IOException {
    ...
    private void initUI() {
        ...
        JFrame jframe = new JFrame("Item List");
